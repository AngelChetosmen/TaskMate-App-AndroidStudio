    ...
    private fun moreMenuOptions(menu: ImageButton){
        ...
        popup.setOnMenuItemClickListener {
            when (it.itemId) {
                ...
                R.id.all -> {
                    findNavController(R.id.fragments).navigate(R.id.all)
                    Animatoo.animateSlideLeft(this)
                }
                R.id.work -> {
                    findNavController(R.id.fragments).navigate(R.id.work)
                    Animatoo.animateSlideLeft(this)
                }
                R.id.studies -> {
                    findNavController(R.id.fragments).navigate(R.id.studies)
                    Animatoo.animateSlideLeft(this)
                }
                R.id.personnel -> {
                    findNavController(R.id.fragments).navigate(R.id.personnel)
                    Animatoo.animateSlideLeft(this)
                }
                R.id.important -> {
                    findNavController(R.id.fragments).navigate(R.id.important)
                    Animatoo.animateSlideLeft(this)
                }
            }
            true
